...
export const Sidebar: React.FC<SidebarProps> = ({ user, onLogout, theme, toggleTheme }) => {
  ...
  return (
    <aside className="w-72 h-screen fixed left-0 top-0 border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 flex flex-col p-6 z-40 transition-colors duration-300">
      ...
      <div className="mt-auto pt-6 border-t border-slate-100 dark:border-slate-800 relative" ref={dropdownRef}>
        <AnimatePresence>
          {showProfileActions && (
            <motion.div 
