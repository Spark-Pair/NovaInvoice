          ...
          >
            ...
            <div className="p-8 pb-6 flex items-center justify-between bg-white dark:bg-[#080C1C] relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white leading-tight">Filters</h2>
                  <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-0.5">Refine your view</p>
                </div>
              </div>
              <button
                onClick={onClose}
                className="p-2.5 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-2xl transition-all text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 group"
              >
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">Identity</h3>
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                  </div>
                  <div className="space-y-4">
                    <Input 
                      label="Username" 
                      placeholder="e.g. horizon_admin" 
                      value={filters.username || ''}
                      onChange={(e) => updateFilter('username', e.target.value)}
                    />
                    <Input 
                      label="Business Name" 
                      placeholder="e.g. Horizon Digital" 
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">Taxation</h3>
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                  </div>
                  <div className="space-y-4">
                    <Input 
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">Status & Type</h3>
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                  </div>
                  <div className="space-y-4">
                    <Select 
                ...
                <div className="space-y-4 pb-8">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                    <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">Created Date</h3>
                    <div className="h-[1px] flex-1 bg-slate-100 dark:bg-slate-800/50"></div>
                  </div>
            ...
            <div className="p-8 pt-6 border-t border-slate-100 dark:border-slate-800/50 bg-white/80 dark:bg-[#080C1C]/80 backdrop-blur-md flex gap-4">
              <Button 
                variant="secondary" 
                className="flex-1 rounded-2xl font-black uppercase tracking-widest text-[10px] h-14 border-slate-200 dark:border-slate-800"
                onClick={onClear}
